<?php
    ...
    , COURSE.courseDivide, COURSE.coursePersonnel, COURSE.courseTime FROM COURSE, SCHEDULE_UNI WHERE COURSE.courseID = SCHEDULE_UNI.courseID
    GROUP BY SCHEDULE_UNI.courseID ORDER BY COUNT(SCHEDULE_UNI.courseID) DESC LIMIT 5 ");
    $response = array();
